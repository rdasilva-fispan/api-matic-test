...
package cloud.fispan.dev1.http.client;

import cloud.fispan.dev1.ApiHelper;
import cloud.fispan.dev1.http.Headers;
import cloud.fispan.dev1.http.request.HttpBodyRequest;
import cloud.fispan.dev1.http.request.HttpMethod;
import cloud.fispan.dev1.http.request.HttpRequest;
import cloud.fispan.dev1.http.request.MultipartFileWrapper;
import cloud.fispan.dev1.http.request.MultipartWrapper;
import cloud.fispan.dev1.http.response.HttpResponse;
import cloud.fispan.dev1.http.response.HttpStringResponse;
import cloud.fispan.dev1.utilities.FileWrapper;
